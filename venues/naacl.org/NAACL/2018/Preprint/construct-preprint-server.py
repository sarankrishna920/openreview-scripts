...
from openreview.webfield import Webfield
...
homepage = webfield.Homepage(constants = {
...
naacl_preprint_server = conference.Conference('naacl.org/NAACL/2018/Preprint', 'NAACL Preprint Server')

naacl_preprint_server.add_submission('Submission',
  1527757200000, # 17:00:00 EST on May 1, 2018
  blind_name = 'Blind_Submission')
